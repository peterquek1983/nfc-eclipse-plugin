...
![![](http://wiki.nfc-eclipse-plugin.googlecode.com/git/images/tutorial/test2.png)](http://wiki.nfc-eclipse-plugin.googlecode.com/git/images/tutorial/test2.png)<br />
